...
class ProductDetail {
    ...
    factory ProductDetail.fromJson(Map<String, dynamic> json) => ProductDetail(
        ...
        similars: json["similars"] == null ? [] : List<Similar>.from(json["similars"]!.map((x) => Similar.fromJson(x))),
        breadcrumb: json["breadcrumb"] == null ? [] : List<Breadcrumb>.from(json["breadcrumb"]!.map((x) => Breadcrumb.fromJson(x))),
        rating: json["rating"],
        feedbacks: json["feedbacks"] == null ? [] : List<dynamic>.from(json["feedbacks"]!.map((x) => x)),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "similars": similars == null ? [] : List<dynamic>.from(similars!.map((x) => x.toJson())),
        "breadcrumb": breadcrumb == null ? [] : List<dynamic>.from(breadcrumb!.map((x) => x.toJson())),
        "rating": rating,
...
class DataImages {
    ...
    factory DataImages.fromJson(Map<String, dynamic> json) => DataImages(
        ...
        additional: json["additional"] == null ? [] : List<Main>.from(json["additional"]!.map((x) => Main.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "main": main?.toJson(),
        "additional": additional == null ? [] : List<dynamic>.from(additional!.map((x) => x.toJson())),
    };
}
...
class Similar {
    ...
    factory Similar.fromJson(Map<String, dynamic> json) => Similar(
        ...
        discount: json["discount"],
        discountedPrice: json["discountedPrice"],
        images: json["images"] == null ? null : SimilarImages.fromJson(json["images"]),
        breadcrumb: json["breadcrumb"] == null ? [] : List<Breadcrumb>.from(json["breadcrumb"]!.map((x) => Breadcrumb.fromJson(x))),
        rating: json["rating"],
    );
